 ...
 * 
 * @author <a href="mailto:aron@idega.com">aron </a>,<a href="mailto:tryggvi@idega.com">Tryggvi Larusson</a>
 * @version $Revision: 1.1 $
 */
public class H2RDBMSAdapter extends StandardRDBMSAdapter {
//	CommonRDBMSAdapter {

    public H2RDBMSAdapter(Service service, Logger logger) {
